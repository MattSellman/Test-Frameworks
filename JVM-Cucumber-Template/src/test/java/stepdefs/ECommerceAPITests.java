...
import utils.objects.ECommerce.LoginRequest;
import utils.objects.ECommerce.LoginResponse;
import utils.objects.ECommerce.OrderDetail;
import utils.objects.ECommerce.Orders;
...
//Delete Product
        ...
        assertEquals("Product Deleted Successfully",js1.get("message"));
